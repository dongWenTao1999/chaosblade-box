...
public class ExperimentController extends BaseController {
    ...
    @ApiOperation(value = "通过AppCode初始化演练内容")
    ...
    @ApiOperation(value = "根据演练ID查询演练变更记录")
