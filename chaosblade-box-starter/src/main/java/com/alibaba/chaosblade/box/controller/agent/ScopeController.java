...
public class ScopeController extends BaseController {
    ...
    @ApiOperation(value = "统计机器不同日期的演练数目")
    ...
    @ApiOperation(value = "统计机器涉及到的演练场景")
    ...
    @ApiOperation(value = "根据主机ID分页查询当前主机的演练任务")
