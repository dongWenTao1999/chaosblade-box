...
public class ExperimentTaskController extends BaseController {
    ...
    @ApiOperation(value = "根据演练任务ID查询某次演练任务详情")
    ...
    @ApiOperation(value = "根据演练任务ID查询演练任务概要")
    ...
    @ApiOperation(value = "获取用户演练任务统计信息")
    ...
    @ApiOperation(value = "获取用户演练任务统计信息,不区分namespace")
    ...
    @ApiOperation(value = "根据演练ID获取演练任务列表")
    ...
    @ApiOperation(value = "根据演练ID统计演练任务结果")
    ...
    @ApiOperation(value = "根据演练任务ID分页查询演练任务概要")
    ...
    @ApiOperation(value = "根据演练任务ID查询恢复策略信息")
    ...
    @ApiOperation(value = "根据演练ID查询演练数量")
