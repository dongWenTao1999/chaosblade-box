...
public class ApplicationController extends BaseController {
    ...
    @ApiOperation(value = "获取用户的应用基本信息以及演练情况")
    ...
    @ApiOperation(value = "根据应用ID获取应用概览")
    ...
    @ApiOperation(value = "获取指定应用的演练记录")
    ...
    @ApiOperation(value = "获取指定应用的机器列表")
    ...
    @ApiOperation(value = "获取用户所有的应用分组")
    ...
    @ApiOperation(value = "获取当前应用分组下的所有机器列表")
    ...
    @ApiOperation(value = "根据应用ID获取指定应用配置")
    ...
    @ApiOperation(value = "统计指定应用分组中的机器数量")
    ...
    @ApiOperation(value = "根据应用配置ID查询主机")
